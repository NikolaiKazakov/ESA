...
@NamedQueries({
        @NamedQuery(name = CvModel.ALL_SORTED, query = "SELECT c FROM CvModel c ORDER BY c.releaseDate DESC"),
        @NamedQuery(name = CvModel.DELETE, query = "DELETE FROM CvModel c WHERE c.id=:id"),
})
public class CvModel extends AbstractBaseEntity {
    public static final String ALL_SORTED = "CvModel.getAllSorted";
    public static final String DELETE = "CvModel.delete";
